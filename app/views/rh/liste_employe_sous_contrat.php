...
<body>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <span class="badge bg-secondary fs-6" style="font-family: 'Poppins', sans-serif; font-weight: 500;"><?= count($employes ?? []) ?> employé(s)</span>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="collapse" id="filterCollapse">
                <div class="card-body">
                    <form method="GET" action="/rh/menu_employe/employes-contrat" class="row g-3">
                        <div class="col-md-3">
