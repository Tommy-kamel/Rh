...
<head>
    ...
    <title>Recrutement - SARL TANA SERVICES</title>
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            ...
            <p>Gérez efficacement votre processus de recrutement de A à Z</p>
        </div>
        ...
        <div class="cards-grid">
            <div class="card">
                ...
                <p>Créez et gérez des annonces de recrutement pour différents postes dans votre organisation.</p>
                <a href="/rh/annonces/creer" class="btn">
            ...
            <div class="card">
                ...
                <h5>Examiner les candidatures</h5>
                <p>Consultez et évaluez les candidatures reçues pour les différentes annonces publiées.</p>
                <a href="/rh/recrutement/candidatures" class="btn">
                    <i data-feather="arrow-right"></i>
                    Accéder
                </a>
            </div>
            ...
            <div class="card">
                ...
                <h5>Planifier les entretiens</h5>
                <p>Programmez des entretiens avec les candidats sélectionnés et gérez votre planning.</p>
                <a href="/liste_fonctions" class="btn">
                    <i data-feather="arrow-right"></i>
                    Accéder
                </a>
            </div>
