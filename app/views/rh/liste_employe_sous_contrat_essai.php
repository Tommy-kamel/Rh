    ...
    <div class="container">
        ...
        <div class="filter-card">
            ...
            <div class="filter-body" id="filterBody">
                <form method="GET" action="/rh/menu_employe/employes-contrat-essai">
                    ...
                    <tbody>
                         <?php foreach ($employes as $employe): ?>
                            <tr>
                                ...
                                <td><?= number_format($employe['salaire'] ?? 0, 0, ',', ' ') ?> Ar</td>
                                <td>
                                    <div class="actions-group">
                                        <a href="/rh/employe-essai/embaucher/<?= $employe['id_contrat_essai'] ?>" class="btn btn-success">
